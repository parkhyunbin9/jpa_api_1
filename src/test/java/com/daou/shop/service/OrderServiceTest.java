package com.daou.shop.service;

import com.daou.shop.domain.Address;
import com.daou.shop.domain.Member;
import com.daou.shop.domain.Order;
import com.daou.shop.domain.OrderStatus;
import com.daou.shop.domain.item.Book;
import com.daou.shop.domain.item.Item;
import com.daou.shop.exception.NotEnoughStockException;
...
public class OrderServiceTest {
    ...
    public void 상품주문() throws Exception {
        ...
        assertEquals("주문 가격 = 가격 * 수량이다.", 10000 * orderCount, getOrder.getTotalPrice());
